...
export default function Contact() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      setStatus('error');
      setErrorMsg(err.message || 'An error occurred while sending the message. Please try again.');
    }
  };
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 pt-28">
      ...
      <div ref={titleRef} className="reveal">
        <SectionTitle
          tag="Contact"
          title="Let's talk" 
          subtitle="Do you have a project in mind? Would you like to collaborate or just chat? Send me a message."
        />
      </div>
      ...
      <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="p-8 rounded-2xl bg-white dark:bg-slate-800
            ...
            {status === 'success' && (
              <div className="mb-6 p-4 rounded-xl bg-green-50 dark:bg-green-900/20
                ...
                <p className="text-sm font-medium">Message sent! I'll get back to you soon. <LuCircleCheckBig color='white' /></p>
              </div>
            )}
        ...
        <div ref={infoRef} className="reveal animate-delay-200 lg:col-span-2 flex flex-col gap-4">
          ...
          <ContactInfo
            href="mailto:karen.cordoba046@gmail.com"
            icon={
            ...
            title="Email"
            value="karen.cordoba046@gmail.com"
          />

          <ContactInfo
            href="https://linkedin.com/in/karen-cordoba16"
            icon={
            ...
            title="LinkedIn"
            value="linkedin.com/in/karen-cordoba16"
          />

          <ContactInfo
            href="https://github.com/KarenCordoba16"
            icon={
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            title="GitHub"
            value="github.com/KarenCordoba16"
          />
          ...
          <div className="p-5 rounded-2xl bg-blue-50 dark:bg-blue-900/20
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
              I am currently accepting freelance projects and am open to proposals for remote or hybrid work.
            </p>
          </div>
        </div>
      </div>
